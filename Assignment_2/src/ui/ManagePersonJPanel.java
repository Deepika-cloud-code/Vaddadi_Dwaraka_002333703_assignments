...
public class ManagePersonJPanel extends javax.swing.JPanel {
 JPanel userProcessContainer;
    ...
    private void initComponents() {
        ...
        lblManageAccount.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        lblManageAccount.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblManageAccount.setText("Manage Profile");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lblManageAccount, javax.swing.GroupLayout.PREFERRED_SIZE, 513, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(!txtSearchBox.getText().isBlank()){
            String details=txtSearchBox.getText();
            Person foundPerson=personDirectory.searchPerson(details);
            ...
            if(foundPerson!=null){
                ...
                JOptionPane.showMessageDialog(null,"Profile not found. Please check the firstname/lastname/street address and try again.","Warning",JOptionPane.WARNING_MESSAGE);

            }

        }
        else{
            JOptionPane.showMessageDialog(null,"Please type the profile firstname/lastname/street address to view.","Warning",JOptionPane.WARNING_MESSAGE);
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        ...
        if(selectedRow>=0){
            ...
            JOptionPane.showMessageDialog(null,"Please select a profile from the list to view.","Warning",JOptionPane.WARNING_MESSAGE);
        }
...
public void populateTable(){
    ...
    for(Person p:personDirectory.getPerson()){
        ...
        row[4]=p.getWorkAddress().getZipCode();
        row[5]=p.getHomeAddress().getCity();
        row[6]=p.getHomeAddress().getZipCode();
